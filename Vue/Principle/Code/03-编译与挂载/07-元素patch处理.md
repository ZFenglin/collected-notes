...
2. createPatchFunction中，当sameVnode(oldVnode, vnode)时则会执行patchVnode，决定如何去处理节点
3. patchVnode中，当新旧节点不同，但是都具有子节点时，则会调用updateChildren处理子节点的diff比较
